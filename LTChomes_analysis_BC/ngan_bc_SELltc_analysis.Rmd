...
listofcol = list('outbreak', 'rooms_semi_binary', 'rooms_multi_binary', 'rooms_shared', 'resident_council', 'family_council', 'res_fam_council', 'beds_privatebinary')
...
xtabs(~outbreak + rooms_shared, data=df)
