...
# Import the data
df <- read.csv("../data/bc_ltc_odhf_final.csv", na.strings="", header=TRUE)
colnames(df)
```
...
rmv <- c("Pruid", "CSDname", "source_facility_type", "provider", "odhf_facility_type",
         "facility_name", "HCC_CODE", "HLTH_AUTH", "STREET_ADDRESS", "CITY", "POSTAL", "province", "PHONE", "OPEN_DATE", 
...
Around 2 or 3 predictors are necessary.
