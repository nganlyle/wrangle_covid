...
# Import the data
df <- read.csv("../data/bc-ltc-FINAL.csv", na.strings="", header=TRUE)
colnames(df)
```
...
rmv <- c("X", "Unnamed..0", "Unnamed..0.1", "facility_name", "HCC_CODE", "HLTH_AUTH", "STREET_ADDRESS", "CITY", "POSTAL", "PHONE", "FACILITY_NAME",
