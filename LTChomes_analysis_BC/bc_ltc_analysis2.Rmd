...
rmv <- c("facility_name", "HCC_CODE", "HLTH_AUTH", "STREET_ADDRESS", "CITY", "POSTAL", "PHONE", 
         "OPEN_DATE",  "provider", "BUSINESS_PHONE",
        ...
        'latitude', 'longitude', 'point', 'LATITUDE', 'LONGITUDE', 'geometry',
