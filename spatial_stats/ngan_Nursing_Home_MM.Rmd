...
nursing_home <- read.csv2('LTC Outbreaks Case Numbers Updated (Accurate as of June 24 2020).csv', sep=',')
...
i = 1
for (i in 1:615) {
  if (nursing_home$confirmed_resident_cases[i] == '0') {
...
nursing_home$resident_deaths<-as.character(nursing_home$resident_deaths)
# i = 1
...
# 4326 is the EPSG identifier of WGS84, it means lat and long coordinates on the WGS84 reference ellopsoid
...
leaflet(nursing_home) %>%
  ...
  addCircleMarkers(#lng = ~longitude, lat = ~latitude, 
    ...
    fillColor = ptCol$plot, 
    fillOpacity = 0.8, 
    radius = 3, 
    stroke = FALSE) %>%
  addLegendCustom(colors = ptCol$col, labels = legendLabs, sizes = 6, font.sizes = 2, group='Number of deaths')
