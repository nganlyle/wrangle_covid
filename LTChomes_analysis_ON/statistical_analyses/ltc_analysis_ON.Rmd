...
df$complaints_norm <- df$total_complaints/df$number_beds
...
data <- subset(df, select = c(keep, profile, quality, all_inspections, complaints))
...
# listofcols = c('number_beds', quality, all_inspections, complaints)
